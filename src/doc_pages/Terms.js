  ...
  return (
    <div className="container">
      ...
      <p>
        ...
        of Neighbourgoods's Website, located at neighbourgoods.netlify.app.
      </p>
      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Neighbourgoods if you do not agree to
      ...
      <p>
        We employ the use of cookies. By accessing Neighbourgoods, you agreed to
        use cookies in agreement with the Neighbourgoods's Privacy Policy.
      </p>
      <p>
      ...
      <h3>License</h3>
      <p>
        Unless otherwise stated, Neighbourgoods and/or its licensors own the
        intellectual property rights for all material on Neighbourgoods. All
        intellectual property rights are reserved. You may access this from
        Neighbourgoods for your own personal use subjected to restrictions set
        in these terms and conditions.
      </p>
      <p>You must not:</p>
      <ul>
        <li>Republish material from Neighbourgoods</li>
        <li>Sell, rent or sub-license material from Neighbourgoods</li>
        <li>Reproduce, duplicate or copy material from Neighbourgoods</li>
        <li>Redistribute content from Neighbourgoods</li>
      </ul>
      <p>This Agreement shall begin on the date hereof.</p>
      <p>
        Parts of this website offer an opportunity for users to post and
        exchange opinions and information in certain areas of the website.
        Neighbourgoods does not filter, edit, publish or review Comments prior
        to their presence on the website. Comments do not reflect the views and
        opinions of Neighbourgoods,its agents and/or affiliates. Comments
        reflect the views and opinions of the person who post their views and
        opinions. To the extent permitted by applicable laws, Neighbourgoods
      ...
      <p>
        Neighbourgoods reserves the right to monitor all Comments and to remove
      ...
      <p>
        You hereby grant Neighbourgoods a non-exclusive license to use,
      ...
      <p>
        We will approve link requests from these organizations if we decide that: (a) the link would not make us look unfavorably to ourselves or to our accredited businesses; (b) the organization does not have any negative records with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of Neighbourgoods; and (d) the link is in the context of general resource information.
      </p>
      <p>
      ...
      <p>
        ...
        e-mail to Neighbourgoods. Please include your name, your organization
      ...
      <p>
        No use of Neighbourgoods's logo or other artwork will be allowed for
